...
<div class="form-group">
  ...
  <label class="col-md-4 control-label" for="dept">Department Name</label>  
  <div class="col-md-4">
      <input id="dept" name="dept"  type="text" placeholder="Department name" class="form-control input-md" required="">
    </div>
  </div>
</div>
