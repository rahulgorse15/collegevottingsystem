...
<%@ page import="Controller.Viewelection"%>
<div align="center"> 
	<h1>View Election</h1>
        <form class="form-horizontal" action="viewelection1.jsp" method="post">
<fieldset>

<!-- Select Basic -->
<div class="form-group">
  <div class="row" align="center">
  <label class="col-md-4 control-label" for="elenction">Election</label>
  <%ResultSet rs =null;%>
  <%
    try{
